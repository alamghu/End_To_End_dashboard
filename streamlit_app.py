...
Tubing_ID = st.sidebar.number_input("Tubing ID (inch)", min_value = 2.99, max_value = 7.0,value =3.74)
Casing_Depth_HUD = st.sidebar.number_input("End of Cas-ing/Tubing Depth (feet)", min_value = 100, max_value = 30000, value =15000)
Casing_ID = st.sidebar.number_input("Casing/Tubing ID (inch)", min_value = 2.99, max_value = 10.0, value =3.74)
####################
# Logic & Calculation
